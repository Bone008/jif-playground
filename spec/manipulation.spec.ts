...
describe('addManipulator', () => {
  ...
  it('works for Scrambled V', () => {
    ...
    expect(output).toEqual(jasmine.objectContaining({
      ...
      throws: [
        { time: 0, duration: 3, from: 6, to: 3 },
        { time: 1, duration: 3, from: 1, to: 0 },
        { time: 2, duration: 3, from: 0, to: 5 },
        { time: 3, duration: 3, from: 1, to: 0 },
        { time: 4, duration: 3, from: 0, to: 3 },
        { time: 5, duration: 3, from: 1, to: 0 },
        { time: 0, duration: 3, from: 2, to: 1 },
        { time: 1, duration: 3, from: 3, to: 2 },
        { time: 2, duration: 1, from: 2, to: 7 },
        { time: 3, duration: 3, from: 3, to: 2 },
        { time: 4, duration: 3, from: 2, to: 1 },
        { time: 5, duration: 3, from: 3, to: 2 },
        { time: 0, duration: 3, from: 4, to: 5 },
        { time: 1, duration: 3, from: 5, to: 4 },
        { time: 2, duration: 3, from: 4, to: 1 },
        { time: 3, duration: 3, from: 5, to: 4 },
        { time: 4, duration: 3, from: 4, to: 7 },
        { time: 0, duration: 2, from: 0, to: 0 },
        { time: 5, duration: 2, from: 5, to: 5 },
        { time: 4, duration: 1, from: 6, to: 7 },
        { time: 5, duration: 1, from: 7, to: 6 },
        { time: 1, duration: 1, from: 7, to: 6 },
        { time: 2, duration: 3, from: 6, to: 3 },
        { time: 3, duration: 1, from: 7, to: 6 },
      ],
    }));
  });
  ...
  it('works for Unscrambled B', () => {
    ...
    expect(output).toEqual(jasmine.objectContaining({
      ...
      throws: [
        { time: 0, duration: 3, from: 0, to: 7 },
        { time: 1, duration: 3, from: 1, to: 0 },
        { time: 2, duration: 3, from: 0, to: 5 },
        { time: 3, duration: 3, from: 1, to: 0 },
        { time: 4, duration: 3, from: 0, to: 7 },
        { time: 5, duration: 3, from: 1, to: 0 },
        { time: 0, duration: 3, from: 2, to: 1 },
        { time: 2, duration: 2, from: 6, to: 6 },
        { time: 2, duration: 3, from: 2, to: 7 },
        { time: 3, duration: 3, from: 7, to: 6 },
        { time: 4, duration: 1, from: 6, to: 3 },
        { time: 5, duration: 3, from: 7, to: 6 },
        { time: 0, duration: 3, from: 4, to: 5 },
        { time: 1, duration: 3, from: 5, to: 4 },
        { time: 2, duration: 3, from: 4, to: 1 },
        { time: 3, duration: 3, from: 5, to: 4 },
        { time: 4, duration: 3, from: 4, to: 5 },
        { time: 5, duration: 3, from: 5, to: 4 },
        { time: 1, duration: 2, from: 3, to: 3 },
        { time: 0, duration: 1, from: 6, to: 7 },
        { time: 1, duration: 1, from: 7, to: 6 },
        { time: 3, duration: 1, from: 3, to: 2 },
        { time: 4, duration: 3, from: 2, to: 1 },
        { time: 5, duration: 1, from: 3, to: 2 },
      ],
    }));
  });
});
